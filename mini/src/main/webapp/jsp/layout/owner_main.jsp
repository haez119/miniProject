	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item dropdown"><a
				...
				aria-expanded="false" onfocus="blur()"> 테마 </a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" onfocus="blur()"
						href="${pageContext.request.contextPath}/reserveList.do">테마리스트
					</a> <a class="dropdown-item" onfocus="blur()"
						href="${pageContext.request.contextPath}/ownerThemaList.do">지점
						테마리스트 </a> <a class="dropdown-item" onfocus="blur()"
						href="${pageContext.request.contextPath}/themaInsertForm.do">테마등록
					</a>
				</div></li>
